  ...
  return (
    ...
    <Toaster/>
      <main id="content" role="main" className="w-full xl:px-80 lg:px-40 md:px-40 p-6">
        <div className="mt-7 bg-white xl:px-40 xl:py-20 lg:px-20 lg:py-20 md:px-20 md:py-20 sm:px-10 sm:py-10 rounded-xl shadow-lg border-2 border-indigo-300">
        ...
        <p className="mt-3  text-center divide-x divide-gray-300">
          <strong>Did you mistakenly Unsubscribed from Prokritee&apos;s Newsletter? |</strong> | Mail us at contact@prokritee.com to subscribe again.
        </p>
      </main>
    </>
  );
